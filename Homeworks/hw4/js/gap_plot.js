...
class GapPlot {
    ...
    drawPlot() {
        ...
        // let xAxisBar = this.svgGroup.append('g')
        //                            .call(xAxis)
        //                            .classed("axis", true)
        //                            .attr("transform", "translate(" + temp + ")");

        // this.xAxisBarWithTicks = xAxisBar.selectAll(".tick").classed("axis-label", true);
        ...
        // let yAxisBar = this.svgGroup.append('g')
        //                            .call(yAxis)
        //                            .classed("axis", true)
        //                            .attr("transform", "translate(" + temp + ")");

        // this.yAxisBarWithTicks = yAxisBar.selectAll(".tick").classed("axis-label", true);
    ...
    updatePlot(activeYear, xIndicator, yIndicator, circleSizeIndicator) {
        ...
        */
        ...
        try{
            ...
            let xScale = d3.scaleLinear().domain([this.dataRange[xIndicator].min, this.dataRange[xIndicator].max]).range([0, this.width]);
            ...
            let yScale = d3.scaleLinear().domain([this.dataRange[yIndicator].min, this.dataRange[yIndicator].max]).range([this.height - this.margin.top, 0]);
            let yAxis = d3.axisLeft()
                      .scale(yScale);
